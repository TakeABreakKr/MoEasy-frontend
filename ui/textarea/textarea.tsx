import React, { ChangeEvent, forwardRef, useLayoutEffect } from 'react';
...
export const Textarea = forwardRef<HTMLTextAreaElement, AutoResizeTextareaProps>(
  ({ onValueChange, dispatchError, minHeight = 40, maxHeight = 400, isError, className, maxLength, ...props }, ref) => {
